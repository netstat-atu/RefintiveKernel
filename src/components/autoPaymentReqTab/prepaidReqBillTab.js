...
//** service */
import { adminAutoPaymentManage, billerNameRequest, billerNameStates, downloadExcelFromAPI, payRequestList } from '../../utils/bbps/billerServices';
...
const PrepaidReqBillTab = () => {
    ...
    const initiatePayment = async () => {
        ...
        console.log("🚀 ~ file: prepaidBillTab.js:162 ~ statusPayment ~ body:", body)
    ...
    const getPrepaidBill = async () => {
        showLoader()
        let body = {
            "type": excelName.PREPAID_REQ_BILL,
            "data": filterBody
        }
    ...
    const downloadExcel = async () => {
        try {
            ...
            const body = {
                "type": "CREATE",
                "id": id,
                "name": excelName.PREPAID_REQ_BILL,
                "data": filterBody,
                "orgId": orgId,
                "userId": userId
            }
...
export default PrepaidReqBillTab