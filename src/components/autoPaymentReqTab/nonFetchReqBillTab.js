...
//** service */
import { billerNameRequest, billerNameStates, payRequestList } from '../../utils/bbps/billerServices';
...
const NonFetchReqBillTab = () => {
    ...
    const getNonFetchBill = async () => {
        showLoader()
        let body = {
            "type": excelName.NON_FETCH_REQ_BILL,
            "data": filterBody
        }
    ...
    const downloadExcel = async () => {
        try {
            ...
            const body = {
                "type": "CREATE",
                "id": id,
                "name": excelName.NON_FETCH_REQ_BILL,
                "data": filterBody,
                "orgId": orgId,
                "userId": userId
            }
...
export default NonFetchReqBillTab