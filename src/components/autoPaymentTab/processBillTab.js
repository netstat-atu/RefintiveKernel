...
const ProcessBillTab = () => {
    ...
    const initiatePayment = async () => {
        ...
        await adminAutoPayment(body).then(() => {
            ...
            console.log("🚀 ~ file: ProcessBillTab.js:69 ~ await adminAutoPayment ~ error:", error);
        }).finally(() => {
            hideLoader()
            console.log('finally :>> ');
        });
    ...
    const downloadPaymentReport = async (link) => {
        ...
        await adminAutoPaymentManage(body).then((resp) => {
            ...
            console.log("🚀 ~ file: ProcessBillTab.js:115 ~ await adminAutoPaymentManage ~ error:", error)
        }).finally(() => {
            hideLoader()
        });
    }
    ...
    const getPaymentList = async () => {
        ...
        await adminAutoPaymentManage(body).then((resp) => {
            ...
            console.log("🚀 ~ file: ProcessBillTab.js:155 ~ await adminAutoPaymentManage ~ error:", error)
        }).finally(() => {
            hideLoader()
        });
    }
